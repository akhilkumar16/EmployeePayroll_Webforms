    ...
    <div class="grid">
        <asp:GridView ID="GridView2" runat="server" BackColor="White" CellPadding="4" GridLines="Horizontal" AutoGenerateColumns="False" Width="1090px" ForeColor="Black">
            <Columns>
                ...
                <asp:BoundField DataField="Emp_name" HeaderText="Emp_name" SortExpression="Name" />
                <asp:BoundField DataField="gender" HeaderText="Gender" SortExpression="Gender" />
                <asp:BoundField DataField="EmployeeDepartment" HeaderText="Department" SortExpression="Department" />
                <asp:BoundField DataField="salary" HeaderText="salary" SortExpression="Salary" />
                <asp:BoundField DataField="start" HeaderText="StartDate" SortExpression="StartDate" />
